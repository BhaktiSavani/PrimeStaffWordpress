...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( BIZIPRESS_INC . '/includes/option-types/new-icon/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'bizipress' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'bizipress' ),
					'hand'				 => esc_html__( 'Hand Icons', 'bizipress' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'bizipress' ),
					'gender'			 => esc_html__( 'Gender Icons', 'bizipress' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'bizipress' ),
					'payment'			 => esc_html__( 'Payment Icons', 'bizipress' ),
					'currency'			 => esc_html__( 'Currency Icons', 'bizipress' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'bizipress' ),
					'directional'		 => esc_html__( 'Directional Icons', 'bizipress' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'bizipress' ),
					'brand'				 => esc_html__( 'Brand Icons', 'bizipress' ),
					'medical'			 => esc_html__( 'Medical Icons', 'bizipress' ),
					'finences-icons'	 => esc_html__( 'Finences Icons', 'bizipress' ),
				),
				'icons'				 => array(
