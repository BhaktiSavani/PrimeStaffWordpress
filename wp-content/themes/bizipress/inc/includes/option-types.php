...
function bizipress_action_theme_include_custom_option_types() {
    if (is_admin()) {
        $dir = BIZIPRESS_INC . '/includes';
...
add_action('fw_option_types_init', 'bizipress_action_theme_include_custom_option_types');
