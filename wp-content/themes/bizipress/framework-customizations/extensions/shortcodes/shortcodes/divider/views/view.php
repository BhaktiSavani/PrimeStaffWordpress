...
if ($atts['special_divider']['selected_value'] == 'text' || $atts['special_divider']['selected_value'] == 'icon') :
    ...
    ?>
    <div <?php echo esc_attr($link_id); ?> class="fw-divider-special <?php echo esc_attr($atts['class']); ?> <?php echo esc_attr($atts['type']); ?> <?php echo esc_attr($size); ?> <?php echo esc_attr($position); ?> <?php echo esc_attr($divider_size); ?> <?php echo  esc_attr($divider_bg_class); ?> <?php echo esc_attr($divider_icon_class); ?>" <?php echo 'style="width:' . esc_attr($atts['width']) . '%; ' . $custom_spacing . '"'; ?> >
        <div class="fw-divider-inner <?php echo esc_attr($divider_inner_class); ?>" style="<?php echo  bizipress_return($special_bg_color); ?>">
            <span class="fw-divider-holder fw-divider-left <?php echo esc_attr($border_class); ?>" style="<?php echo  bizipress_return($bg_color); ?>"></span>
            <span class="fw-divider-title <?php echo esc_attr($divider_title_class); ?>" style="<?php echo  bizipress_return($text_icon_color); ?>">
                <?php if ($type == 'icon') : ?>
                    <i class="<?php echo esc_attr($atts['special_divider']['icon']['icon_class']); ?>"></i>
                <?php else : ?>
                    <?php echo bizipress_theme_translate(esc_attr($atts['special_divider']['text']['title_text'])); ?>
                <?php endif; ?>
            </span>
            <span class="fw-divider-holder fw-divider-right <?php echo esc_attr($border_class); ?>" style="<?php echo bizipress_return($bg_color); ?>"></span>
        </div>
    </div>
    <?php
else:
