...
define('BIZIPRESS_THEMEROOT_DIR', get_parent_theme_file_path());
...
define( 'BIZIPRESS_REMOTE_CONTENT', esc_url('http://xpeedstudio.net/demo-content/bizipress' ));
...
function bizipress_body_classes( $classes ) {
...
add_filter( 'body_class','bizipress_body_classes' );


add_action('enqueue_block_editor_assets', 'bizipress_action_enqueue_block_editor_assets' );
function bizipress_action_enqueue_block_editor_assets() {
   // wp_enqueue_style( 'bizipress-fonts', bizipress_google_fonts_url(['Raleway:400,500,600,700,800,900', 'Roboto:400,700']), null, BIZIPRESS_VERSION );
    wp_enqueue_style( 'bizipress-gutenberg-editor-font-awesome-styles', BIZIPRESS_CSS . '/font-awesome.css', null, BIZIPRESS_VERSION );
    wp_enqueue_style( 'bizipress-gutenberg-editor-customizer-styles', BIZIPRESS_CSS . '/gutenberg-editor-custom.css', null, BIZIPRESS_VERSION );
    wp_enqueue_style( 'bizipress-gutenberg-editor-styles', BIZIPRESS_CSS . '/gutenberg-custom.css', null, BIZIPRESS_VERSION );
    wp_enqueue_style( 'bizipress-gutenberg-blog-styles', BIZIPRESS_CSS . '/blog-style.css', null, BIZIPRESS_VERSION );
}